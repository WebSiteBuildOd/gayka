            ...
            <div class="col-lg-6">
                <div class="footer__right-col">
                    ...
                    <div class="footer__col">
                        <ul>
                            <li><a href="">Стиральные машины-автомат</a></li>
...
<script src="assets/production/libs/slick/slick.min.js"></script>
<script src="assets/production/js/script.js?{''|date:'U'}"></script>
{/ignore}

{*
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-XW8EDNHKVM"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-XW8EDNHKVM');
</script>
  <script>
